...
mod tests {
    ...
    fn test_parse_srt() {
        ...
        assert_eq!(srt, Srt{
			subs:vec!(SubTitle{
				index: 1,
				start_time: Time{hours: 0, minutes: 0, seconds: 1, milliseconds: 123},
				end_time: Time{hours: 0, minutes: 0, seconds: 3, milliseconds: 456},
				text: String::from_str("First line").unwrap(),
			},  SubTitle{
				index: 2,
				start_time: Time{hours: 0, minutes: 1, seconds: 5, milliseconds: 0},
				end_time: Time{hours: 0, minutes: 1, seconds: 6, milliseconds: 010},
				text: String::from_str("Second line,\nand third line.").unwrap(),
            }, SubTitle{
				index: 3,
